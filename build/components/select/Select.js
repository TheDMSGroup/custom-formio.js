...
export class SelectComponent extends BaseComponent {
  ...
  loadItems(url, search, headers, options, method, body) {
    ...
    this.loading = true;
    Formio.makeRequest(this.options.formio, 'select', url, method, body, options).then(response => this.setItems(response)).catch(err => {
      this.loading = false;
  ...
  asString(value) {
    ...
    return _.isObject(value) ? this.itemTemplate(value) : '-';
  }
